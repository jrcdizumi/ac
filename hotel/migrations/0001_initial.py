    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_type', models.IntegerField(choices=[(0, 'turn on/off'), (1, 'increase temp'), (2, 'decrease temp'), (3, 'increase speed'), (4, 'decrease speed'), (5, 'check in'), (6, 'check out')], default=-1, verbose_name='请求类型')),
        ...
        migrations.CreateModel(
            name='Room',
            fields=[
                ('room_id', models.IntegerField(default=0, primary_key=True, serialize=False, verbose_name='房间号')),
                ('start_time', models.DateTimeField(default=django.utils.timezone.now, verbose_name='入住时间')),
